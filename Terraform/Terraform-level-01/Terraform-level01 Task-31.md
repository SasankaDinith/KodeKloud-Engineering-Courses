## Task31 - Delete IAM Group Using Terraform
...
Delete an IAM group named `iamgroup_mark` using `terraform`. Make sure to keep the provisioning code, as we might need to provision this instance again later.
...
Step01: Open the main.tf file and run below command in the terminal 
```
terraform destroy
```
### Task is Completed!
