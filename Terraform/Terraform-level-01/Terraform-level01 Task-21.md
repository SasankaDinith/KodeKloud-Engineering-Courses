## Task21- CloudWatch Setup Using Terraform


The Nautilus DevOps team needs to set up CloudWatch logging for their application. They need to create a CloudWatch log group and 
log stream with the following specifications:
...
resource "aws_cloudwatch_log_stream" "nautilus_log_grouplog_stream" {
