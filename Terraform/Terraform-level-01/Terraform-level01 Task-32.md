## Task32 - Delete IAM Role Using Terraform
...
Delete the IAM role named `iamrole_mariyam` using `Terraform`. Make sure to keep the provisioning code, as we might need to provision this instance again later.
